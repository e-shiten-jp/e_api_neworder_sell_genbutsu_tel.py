...
# 引数6: 株数
# 引数7: 口座属性クラス
def func_order_genbutsu_buy(str_sIssueCode,
                                  str_sSizyouC,
                                  str_sCondition,
                                  str_sOrderPrice,
                                  str_sOrderSuryou,
    ...
    str_sGyakusasiOrderType = '0'    # 18.逆指値注文種別  0:通常、1:_gen逆指値、2:通常+逆指値
    ...
    str_key = '"p_no"'
    str_value = func_check_json_dquat(str(class_login_property.p_no))
...
if __name__ == "__main__":
    ...
    dic_return = func_order_genbutsu_buy(my_sIssueCode,
                                            my_sSizyouC,
                                            my_sCondition,
                                            my_sOrderPrice,
                                            my_sOrderSuryou,
